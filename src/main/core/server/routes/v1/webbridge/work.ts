...
const api: FastifyPluginAsync = async (fastify): Promise<void> => {
  // IPC消息处理端点
  fastify.post(`/${API_PREFIX}/ipc/:channel`, async (req: FastifyRequest<{ 
  ...
  // FFmpeg缩略图生成端点
  fastify.post(`/${API_PREFIX}/ffmpeg/thumbnail`, async (req: FastifyRequest<{ Body: { url: string, id: string } }>) => {
