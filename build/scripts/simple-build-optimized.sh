...
build_component() {
    ...
    case $component_name in
        "shared-components")
            build_script="./build/scripts/build-shared-components-optimized.sh"
            ;;
        "film")
            build_script="./build/scripts/build-film-optimized.sh"
            ;;
        "iptv")
            build_script="./build/scripts/build-iptv-optimized.sh"
            ;;
        "drive")
            build_script="./build/scripts/build-drive-optimized.sh"
            ;;
        "lab")
            build_script="./build/scripts/build-lab-optimized.sh"
            ;;
        "chase")
            build_script="./build/scripts/build-chase-optimized.sh"
            ;;
        "play")
            build_script="./build/scripts/build-play-optimized.sh"
            ;;
        "setting")
            build_script="./build/scripts/build-setting-optimized.sh"
            ;;
        "analyze")
            build_script="./build/scripts/build-analyze-optimized.sh"
            ;;
        "home")
            build_script="./build/scripts/build-home-optimized.sh"
            ;;
        "main")
            build_script="./build/scripts/build-main-optimized.sh"
            ;;
        "test")
            build_script="./build/scripts/build-test-optimized.sh"
            ;;
    esac
...
# 主函数
main() {
    log_info "智能构建脚本启动 (参照zyplayer风格优化)"
